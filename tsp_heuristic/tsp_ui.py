...
# Code partly generated by: PyQt4 UI code generator 4.11.4
#
...
class Ui_Tsp(QtGui.QWidget):
    ...
    def run_tsp(self):
        self.infoText.setText("Calculating Distance Matrix...")
        self.infoText.repaint()
        dist_matrix = self.problem.calc_dist_matrix()
        self.infoText.setText("Solving TSP...")
        self.infoText.repaint()
