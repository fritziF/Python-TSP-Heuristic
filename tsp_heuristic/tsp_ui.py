...
class Ui_Tsp(QtGui.QWidget):
    ...
    def setupUi(self, TSP):
        ...
        self.noimproveBox.setProperty("value", 200)
        self.noimproveBox.setObjectName(_fromUtf8("noimproveBox"))
        self.gridLayout_4.addWidget(self.noimproveBox, 0, 6, 1, 1)
        self.noimproveLabel = QtGui.QLabel(self.widget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(2)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.noimproveLabel.sizePolicy().hasHeightForWidth())
        self.noimproveLabel.setSizePolicy(sizePolicy)
        self.noimproveLabel.setFont(bold_font)
        self.noimproveLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.noimproveLabel.setObjectName(_fromUtf8("noimproveLabel"))
        self.gridLayout_4.addWidget(self.noimproveLabel, 0, 5, 1, 1)
        ...
        self.iterationBox.setProperty("value", 800)
    ...
    def retranslateUi(self, TSP):
        ...
        self.noimproveLabel.setText(_translate("TSP", "Set no-improvement limit:", None))
    ...
    def run_tsp(self):
        self.problem.setParameters(self.iterationBox.value(), self.noimproveBox.value())
